...
/**
 * @file
 * Font loading js - https://www.zachleat.com/web/comprehensive-webfonts/#critical-foft-data-uri
 *
 */

(function ($, Drupal, window, document, undefined) {
  'use strict';
  Drupal.behaviors.fontLoader = {
    attach: function (context, settings) {

      $('body.font-loader').once('fontLoader', function() {

        var TIMEOUT = 15000;
        var font_light = new FontFaceObserver('Open Sans', { weight: 300 });
        var font_regular = new FontFaceObserver('Open Sans', { weight: 400 });
        var font_regular_italic = new FontFaceObserver('Open Sans', { weight: 400, style: 'italic' });
        var font_semibold = new FontFaceObserver('Open Sans', { weight: 600 });
        var font_bold = new FontFaceObserver('Open Sans', { weight: 700 });


        function complete() {
          $('body.font-loader').addClass('font-loaded');
        }
        ...
        Promise.all([font_light.load(null, TIMEOUT), font_regular.load(null, TIMEOUT), font_regular_italic.load(null, TIMEOUT), font_semibold.load(null, TIMEOUT), font_bold.load(null, TIMEOUT)]).then(function () {
          // Optimization for Repeat Views
          sessionStorage.criticalFoftDataUriFontsLoaded = true;
          complete();
        }, function() {
          console.log('Opens Sans font not loaded after ' + (TIMEOUT/1000) + ' seconds');
        });
